package in.stackroute.ust.order.exception.advice;



import in.stackroute.ust.order.exception.OrderAlreadyExistException;
import in.stackroute.ust.order.exception.OrderNotFoundExceprtion;
import in.stackroute.ust.order.exception.dto.ApiError;
import in.stackroute.ust.order.exception.dto.ApiValidationError;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(OrderNotFoundExceprtion.class)
    protected ResponseEntity<Object> handleItemNotFoundExceptionException(OrderNotFoundExceprtion ex) {
        return buildResponseEntity(new ApiError(HttpStatus.NOT_FOUND, ex));
    }
    @ExceptionHandler(OrderAlreadyExistException.class)
    protected ResponseEntity<Object> handleItemAlreadyExistException(OrderAlreadyExistException ex) {
        return buildResponseEntity(new ApiError(HttpStatus.NOT_FOUND, ex));
    }
